...
import (
	...
	hs256auth "github.com/jedi-knights/api-gateway/internal/adapters/inbound/auth/hs256"
	jwksauth "github.com/jedi-knights/api-gateway/internal/adapters/inbound/auth/jwks"
	inboundhttp "github.com/jedi-knights/api-gateway/internal/adapters/inbound/http"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/anthropic"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/circuitbreaker"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/fixedwindow"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/healthhttp"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/leakybucket"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/memory"
	prometheusout "github.com/jedi-knights/api-gateway/internal/adapters/outbound/prometheus"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/proxy"
	retryout "github.com/jedi-knights/api-gateway/internal/adapters/outbound/retry"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/roundrobin"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/slidingwindowcounter"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/slidingwindowlog"
	"github.com/jedi-knights/api-gateway/internal/adapters/outbound/static"
